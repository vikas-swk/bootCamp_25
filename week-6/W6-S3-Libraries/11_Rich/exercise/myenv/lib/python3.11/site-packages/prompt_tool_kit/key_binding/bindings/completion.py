...
from prompt_tool_kit.completion import CompleteEvent, get_common_complete_suffix
from prompt_tool_kit.utils import get_cwidth
from prompt_tool_kit.keys import Keys
from prompt_tool_kit.key_binding.registry import Registry
...
def _display_completions_like_readline(cli, completions):
    ...
    """
    from prompt_tool_kit.shortcuts import create_confirm_application
