...
class EventLoop(with_metaclass(ABCMeta, object)):
    ...
    def run(self, stdin, callbacks):
        ...
        :param stdin: :class:`~prompt_tool_kit.input.Input` instance.
        :param callbacks: :class:`~prompt_tool_kit.eventloop.callbacks.EventLoopCallbacks` instance.
        """
    ...
    def stop(self):
        ...
        :class:`~prompt_tool_kit.interface.CommandLineInterface`, when a result
