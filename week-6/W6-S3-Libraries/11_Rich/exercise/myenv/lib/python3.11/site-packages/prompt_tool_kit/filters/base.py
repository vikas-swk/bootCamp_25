...
from prompt_tool_kit.utils import test_callable_args
...
class Condition(Filter):
    ...
    :param func: Callable which takes either a
        :class:`~prompt_tool_kit.interface.CommandLineInterface` or nothing and
        returns a boolean. (Depending on what it takes, this will become a
        :class:`.Filter` or :class:`~prompt_tool_kit.filters.CLIFilter`.)
    """
